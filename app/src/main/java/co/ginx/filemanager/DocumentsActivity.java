...
import co.ginx.filemanager.archive.DocumentArchiveHelper;
import co.ginx.filemanager.fragment.ConnectionsFragment;
import co.ginx.filemanager.fragment.CreateDirectoryFragment;
import co.ginx.filemanager.fragment.CreateFileFragment;
import co.ginx.filemanager.fragment.DirectoryFragment;
import co.ginx.filemanager.fragment.HomeFragment;
import co.ginx.filemanager.fragment.MoveFragment;
import co.ginx.filemanager.fragment.PickFragment;
import co.ginx.filemanager.fragment.RecentsCreateFragment;
import co.ginx.filemanager.fragment.RootsFragment;
import co.ginx.filemanager.fragment.SaveFragment;
import co.ginx.filemanager.fragment.ServerFragment;
import co.ginx.filemanager.libcore.io.IoUtils;
import co.ginx.filemanager.misc.AnalyticsManager;
import co.ginx.filemanager.misc.AppRate;
import co.ginx.filemanager.misc.AsyncTask;
import co.ginx.filemanager.misc.ConnectionUtils;
import co.ginx.filemanager.misc.ContentProviderClientCompat;
import co.ginx.filemanager.misc.CrashReportingManager;
import co.ginx.filemanager.misc.IntentUtils;
import co.ginx.filemanager.misc.MimePredicate;
import co.ginx.filemanager.misc.PermissionUtil;
import co.ginx.filemanager.misc.PinViewHelper;
import co.ginx.filemanager.misc.PinViewHelper.PINDialogFragment;
import co.ginx.filemanager.misc.ProviderExecutor;
import co.ginx.filemanager.misc.RootsCache;
import co.ginx.filemanager.misc.SAFManager;
import co.ginx.filemanager.misc.SystemBarTintManager;
import co.ginx.filemanager.misc.Utils;
import co.ginx.filemanager.model.DocumentInfo;
import co.ginx.filemanager.model.DocumentStack;
import co.ginx.filemanager.model.DocumentsContract;
import co.ginx.filemanager.model.DocumentsContract.Root;
import co.ginx.filemanager.model.DurableUtils;
import co.ginx.filemanager.model.RootInfo;
import co.ginx.filemanager.network.NetworkConnection;
import co.ginx.filemanager.provider.ExternalStorageProvider;
import co.ginx.filemanager.provider.RecentsProvider;
import co.ginx.filemanager.provider.RecentsProvider.RecentColumns;
import co.ginx.filemanager.provider.RecentsProvider.ResumeColumns;
import co.ginx.filemanager.setting.SettingsActivity;
import co.ginx.filemanager.ui.DirectoryContainerView;
import co.ginx.filemanager.ui.FloatingActionsMenu;
import co.ginx.filemanager.ui.fabs.SimpleMenuListenerAdapter;

import static co.ginx.filemanager.BaseActivity.State.ACTION_BROWSE;
import static co.ginx.filemanager.BaseActivity.State.ACTION_CREATE;
import static co.ginx.filemanager.BaseActivity.State.ACTION_GET_CONTENT;
import static co.ginx.filemanager.BaseActivity.State.ACTION_MANAGE;
import static co.ginx.filemanager.BaseActivity.State.ACTION_OPEN;
import static co.ginx.filemanager.BaseActivity.State.ACTION_OPEN_TREE;
import static co.ginx.filemanager.BaseActivity.State.MODE_GRID;
import static co.ginx.filemanager.BaseActivity.State.MODE_LIST;
import static co.ginx.filemanager.DocumentsApplication.isTelevision;
import static co.ginx.filemanager.fragment.DirectoryFragment.ANIM_DOWN;
import static co.ginx.filemanager.fragment.DirectoryFragment.ANIM_NONE;
import static co.ginx.filemanager.fragment.DirectoryFragment.ANIM_SIDE;
import static co.ginx.filemanager.fragment.DirectoryFragment.ANIM_UP;
import static co.ginx.filemanager.misc.AnalyticsManager.FILE_COUNT;
import static co.ginx.filemanager.misc.AnalyticsManager.FILE_MOVE;
import static co.ginx.filemanager.misc.AnalyticsManager.FILE_TYPE;
import static co.ginx.filemanager.misc.SAFManager.ADD_STORAGE_REQUEST_CODE;
import static co.ginx.filemanager.misc.Utils.EXTRA_ROOT;
import static co.ginx.filemanager.provider.ExternalStorageProvider.isDownloadAuthority;
