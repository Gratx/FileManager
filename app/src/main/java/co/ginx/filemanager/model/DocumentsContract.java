...
import co.ginx.filemanager.misc.OsCompat;
import co.ginx.filemanager.misc.Utils;
import co.ginx.filemanager.provider.DocumentsProvider;
import co.ginx.filemanager.provider.UsbStorageProvider;

import static co.ginx.filemanager.misc.SAFManager.DOCUMENT_AUTHORITY;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "co.ginx.filemanager.action.DOCUMENTS_PROVIDER";
     ...
     * {@link co.ginx.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link co.ginx.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link co.ginx.filemanager.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link co.ginx.filemanager.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link co.ginx.filemanager.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link co.ginx.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link co.ginx.filemanager.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
