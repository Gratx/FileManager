...
import static co.ginx.filemanager.R.id.action_close;
import static co.ginx.filemanager.R.id.action_feedback;
import static co.ginx.filemanager.R.id.action_rate;
