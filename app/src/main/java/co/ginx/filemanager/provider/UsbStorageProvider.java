...
import co.ginx.filemanager.usb.UsbUtils;

import static co.ginx.filemanager.DocumentsApplication.isTelevision;
import static co.ginx.filemanager.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "co.ginx.filemanager.action.USB_PERMISSION";
